...
import { Heart, MessageSquare, Shield, Phone, Mail } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              Your personal health companion, providing smart insights and connecting you with the care you need.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/health-tools" className="text-gray-400 hover:text-white transition-colors">Health Tools</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-2">
                <Phone className="h-5 w-5 mt-0.5 text-brand-primary" />
                <span className="text-gray-400">+1 (555) 123-4567</span>
              </li>
              <li className="flex items-start space-x-2">
                <Mail className="h-5 w-5 mt-0.5 text-brand-primary" />
